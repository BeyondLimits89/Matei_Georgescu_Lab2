...
namespace Matei_Georgescu_Lab2.Migrations
{
    ...
    [Migration("20231217223722_UpdateIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matei_Georgescu_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Matei_Georgescu_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Matei_Georgescu_Lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Matei_Georgescu_Lab2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Matei_Georgescu_Lab2.Models.Borrowing", "BookID");

                    b.HasOne("Matei_Georgescu_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
