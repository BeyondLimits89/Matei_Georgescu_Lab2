...
namespace Matei_Georgescu_Lab2.Models
{
	public class BookCategoriesPageModel: PageModel
	{
		...
		public void PopulateAssignedCategoryData(Matei_Georgescu_Lab2Context context, Book book)
		{
			{
		...
		public void UpdateBookCategories(Matei_Georgescu_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
		{
